...
export const GENRE_INSTRUMENTS: Record<string, string[]> = {
  ...
  pop: ['Polished Synths', 'Electric Guitar', 'Acoustic Guitar', 'Snap Percussion', '808 Bass', 'Drum Machine', 'Piano', 'String Section', 'Catchy Vocal Chops'],
  ...
  rock: ['Distorted Electric Guitar', 'Overdriven Bass', 'Acoustic Drums', 'Crash Cymbals', 'Power Chords', 'Guitar Solo', 'Hammond Organ'],
  ...
  country: ['Acoustic Guitar', 'Pedal Steel', 'Fiddle', 'Banjo', 'Telecaster Twang', 'Harmonica', 'Brushed Snare', 'Mandolin'],
  ...
  cinematic: ['Orchestral Strings', 'Taiko Drums', 'Grand Piano', 'French Horns', 'Choir', 'Timpani', 'Cello Solo', 'Violin Solo', 'Harp', 'Woodwinds', 'Tubular Bells', 'Gong', 'Full Orchestra', 'Spiccato Strings', 'Oboe', 'Clarinet'],
  ...
  jazz: ['Upright Bass', 'Grand Piano', 'Saxophone', 'Trumpet', 'Brushes Drum Kit', 'Hollow Body Guitar', 'Vibraphone', 'Clarinet', 'Trombone', 'String Quartet'],
